...
<?php $this->widget('bootstrap.widgets.TbNavbar', array(
		...
		'items' => array(
			array(
				...
				'items' => array(
					array('label' => 'Directives', 'url' => array('/tblService/view', 'id' =>$_GET['id'])),
					TbHtml::navBarMenuDivider(),
					array('label' => 'Forms', 'url' =>  array('/tblService/forms', 'id' =>$_GET['id'])),
					TbHtml::navBarMenuDivider(),
					array('label' => 'Application', 'url' =>  array('/tblRequest/create', 'id' =>$_GET['id'])),
				),
			),
			array(
				'class' => 'bootstrap.widgets.TbNav',
