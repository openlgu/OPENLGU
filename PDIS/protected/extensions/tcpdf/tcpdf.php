		...
		if ($this->header_xobjid === false) {
			...
			if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
				...
				if (($imgtype == 'eps') OR ($imgtype == 'ai')) {
					...
					$this->Image(K_PATH_IMAGES.$headerdata['logo'], 14, '', $headerdata['logo_width']);
				}
			...
			if ($this->getRTL()) {
				...
				$header_x = $this->original_lMargin + ($headerdata['logo_width'] * 0.5);
			}
			...
			$this->MultiCell($cw, $cell_height, $headerdata['title'], 0, 'C', 0, 1, '', '', true, 0, true, true, 0, 'T', false);
			// header string
			$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
			$this->SetX($header_x);
			$this->MultiCell($cw, $cell_height, $headerdata['string'], 0, 'C', 0, 1, '', '', true, 0, true, true, 0, 'T', false);
