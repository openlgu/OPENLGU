...
/**
 * This is the model class for table "tbl_request_fees_checklist".
 *
 * The followings are the available columns in table 'tbl_request_fees_checklist':
 * @property string $code
 * @property string $service
 * @property integer $_number
 * @property string $accomplished
 */
class TblRequestFeesChecklist extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_request_fees_checklist';
	}
	...
	public function rules()
	{
		...
		return array(
			array('code, service, _number, accomplished', 'required'),
	...
	public function search()
	{
		...
		return new CActiveDataProvider('TblRequestFeesChecklist', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return TblRequestFeesChecklist the static model class
	 */
	...
	public static function getDeficiencies($code, $service)
	{
		...
		$models = TblRequestFeesChecklist::model()->findAll($criteria);
